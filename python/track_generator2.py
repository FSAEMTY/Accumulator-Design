...
def calibrar_escala(img):
    ...
    # Ajuste rápido: dividimos la escala entre 2 para corregir longitud
    escala *= 0.5
    print(f"→ Escala ajustada (dividida entre 2): {escala:.6f} m/pixel")
...
def main():
    ...
    # 0) Calibrar escala (ya ajustada internamente)
